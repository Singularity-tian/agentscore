...
import type { DriftReport, DriftChange } from './types.js';
 ...
 */
function countTools(actions: AgentAction[]): Map<string, number> {
 ...
 */
function computeOrderSimilarity(a: string[], b: string[]): number {
 ...
 */
function computeDriftPercentage(changes: DriftChange[]): number {
